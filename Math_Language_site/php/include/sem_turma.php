<section class="actions">
            <div class="info">
                ...
                <p>O sistema de turmas do nosso site é uma forma divertida de juntar pessoas para jogar e competir.
                    Quando você entra no site, pode criar sua própria turma ou participar de uma existente!</p>

                <p>Além disso, todas as turmas competem no ranking global, somando pontos nos jogos da plataforma. 
