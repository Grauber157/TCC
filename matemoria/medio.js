...
const cardValues = [
    ...
    { expression: '√100', solution: '10' },
    { expression: '10', solution: '√100' },
    { expression: '1⁴', solution: '1' },
    { expression: '1', solution: '1⁴' },
    { expression: '0.5²', solution: '0.25' },
    { expression: '0.25', solution: '0.5²' },
    { expression: '5³', solution: '125' },
    { expression: '125', solution: '5³' },
    { expression: '√64', solution: '8' },
    { expression: '8', solution: '√64' },
    { expression: '0⁹', solution: '0' },
    { expression: '0', solution: '0⁹' },
    { expression: '√49', solution: '7' },
    { expression: '7', solution: '√49' },
];
...
function gameOver() {
    ...
    const maxScore = 40; // Pontuação máxima
    const timeLimit = 20; // Limite de tempo para pontuação máxima
